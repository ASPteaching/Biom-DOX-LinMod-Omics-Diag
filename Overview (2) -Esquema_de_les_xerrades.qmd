---
title: "Biomarkers, Experimental Design, Linear Models, Omics Data and Validation tests"
author: "Alex Sanchez"
date: "`r Sys.Date()`"
format:
  html:
...
Tradicionalment, en els cursos [d'estadística] al VHIR i altres llocs presentem una sèrie de temes relacionats que no solem relacionar. Aquests són:
